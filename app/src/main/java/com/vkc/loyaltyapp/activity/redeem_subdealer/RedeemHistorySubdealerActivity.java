 ...
 */
public class RedeemHistorySubdealerActivity extends AppCompatActivity implements VKCUrlConstants {
    ...
    public void getHistory() {
        ...
        try {
            ...
            final VolleyWrapper manager = new VolleyWrapper(REDEEM_HISTORY_SUBDEALER);
                                    ...
                                    if (status.equalsIgnoreCase("Success")) {
                                        ...
                                        if (dataArray.length() > 0) {
                                            for (int i = 0; i < dataArray.length(); i++) {
                                                ...
                                                model.setRetailer_name(obj.optString("retailer_name"));
                                                listGifts.add(model);
                                            }
                                            SubdealerRedeemAdapter adapter = new SubdealerRedeemAdapter(mContext, listGifts);
